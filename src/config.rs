...
pub const RENDEZVOUS_SERVERS: &[&str] = &["nas.mt.371454510.xyz"];
pub const RS_PUB_KEY: &str = "uRD33RvN2dR6GJtPYMtoyQu1e6K9VyWMh1LvTkDMOvw=";
...
pub mod keys {
    ...
    pub const OPTION_API_SERVER: &str = "http://nas.mt.371454510.xyz:21114";
